...
public class Constants {
	...
	public static final String RM_ORDER_NOT_ADDED = "Raw Material Order not added";
	public static final String PRODUCT_ORDER_NOT_ADDED = "Product Order not added";
	public static final String SUPPLIER_LOGGER_ERROR_DATABASE_NOTCONNECTED = "Database could not be connected!!! ";
	public static final String SUPPLIER_LOGGER_ERROR_FETCHING_FAILED = "Failed to fetch Supplier Details from Database!!!";
	public static final String DISTRIBUTOR_LOGGER_ERROR_DATABASE_NOTCONNECTED = "Database could not be connected";
	public static final String DISTRIBUTOR_LOGGER_ERROR_FETCHING_FAILED = "Failed to fetch Distributor Details from Database";
