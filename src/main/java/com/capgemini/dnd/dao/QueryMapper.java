...
public interface QueryMapper {
	    ...
	    public static final String FETCH_CREDENTIALS = "SELECT Hash, Salt FROM EmployeeCredentials WHERE Username = ?";
	    ...
	    public static final String UPDATE_LOGGED_IN = "UPDATE EmployeeCredentials SET LoggedIn = true WHERE Username = ?";
	    public static final String UPDATE_LOGGED_OUT = "UPDATE EmployeeCredentials SET LoggedIn = false WHERE Username = ?";
	    public static final String UPDATE_PASSWORD = "UPDATE EmployeeCredentials SET Hash = ?, Salt = ? WHERE Username = ? ";
		...
		public static final String FETCH_RMID_FROM_RMNAME = "SELECT rmsId FROM RMSpecs WHERE name = ?";
		public static final String FETCH_PRODUCTID_FROM_PRODUCTNAME = "SELECT pId FROM ProductSpecs WHERE name = ?";
