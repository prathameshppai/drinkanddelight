...
/**
 * Servlet implementation class DisplayRawMaterialOrdersFromSupplierServlet
 */
public class DisplayRawMaterialOrdersFromSupplierServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DisplayRawMaterialOrdersFromSupplierServlet() {
        super();
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        String upperhtml = "<!DOCTYPE html>\r\n" + "<html>\r\n" + "<head>\r\n" + "<meta charset=\"ISO-8859-1\">\r\n"
                + "<title>Display Raw Material Orders From Supplier</title>\r\n"
                ...
                + "                <h1>Raw Material Orders From Supplier</h1>\r\n" + "                \r\n" + "            </div>\r\n"
                + "            <div class=\"col-lg-3\">\r\n"
