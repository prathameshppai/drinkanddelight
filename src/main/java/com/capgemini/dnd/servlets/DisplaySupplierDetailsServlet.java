...
public class DisplaySupplierDetailsServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			supplierDetails = rawmaterialServiceObject.fetchSupplierDetail(supplierDetails);
		} catch (Exception e) {
		...
		String upperhtml = "<!DOCTYPE html>\r\n" + "<html>\r\n" + "<head>\r\n" + "<meta charset=\"ISO-8859-1\">\r\n"
			...
			upperhtml += "<div class=\"table-responsive\">" + "<table class=\"table table-striped\">" + "<tr> <td>"
					+ supplierDetails.getSupplierId() + "</td>&nbsp;<td>" + "<div class=\"col-lg-1\">" + supplierDetails.getName() + "<div>"
					+ "</td>&nbsp;<td>" + supplierDetails.getPhoneNo() + "</td><td>" + supplierDetails.getEmailId() + "</td><td>"
