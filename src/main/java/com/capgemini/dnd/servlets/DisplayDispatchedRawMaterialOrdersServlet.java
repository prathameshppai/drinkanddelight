...
/**
 * Servlet implementation class DisplayDispatchedRawMaterialOrdersServlet
 */
public class DisplayDispatchedRawMaterialOrdersServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public DisplayDispatchedRawMaterialOrdersServlet() {
		super();
...
//        response.getWriter().append("Served at: ").append(request.getContextPath());
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		List<RawMaterialOrder> rmoList = new ArrayList<>();

		try {
			rmoList = rawmaterialServiceObject.displayDispatchedRawMaterialOrderDetails();
		} catch (Exception e) {
			e.printStackTrace();
		}
		String upperhtml = "<!DOCTYPE html>\r\n" + "<html>\r\n" + "<head>\r\n" + "<meta charset=\"ISO-8859-1\">\r\n"
				+ "<title>Display Dispatched Raw Material Orders</title>\r\n"
				...
				+ "                <h1>Dispatched Product Orders</h1>\r\n" + "                \r\n"
				+ "            </div>\r\n" + "            <div class=\"col-lg-3\">\r\n"
