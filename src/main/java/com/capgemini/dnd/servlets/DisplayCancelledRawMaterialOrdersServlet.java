...
public class DisplayCancelledRawMaterialOrdersServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

 

   
    public DisplayCancelledRawMaterialOrdersServlet() {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        String upperhtml = "<!DOCTYPE html>\r\n" + "<html>\r\n" + "<head>\r\n" + "<meta charset=\"ISO-8859-1\">\r\n"
                + "<title>Display Cancelled Raw Material Orders</title>\r\n"
                ...
                + "                <h1>Cancelled Raw Material Orders</h1>\r\n" + "                \r\n" + "            </div>\r\n"
                + "            <div class=\"col-lg-3\">\r\n"
