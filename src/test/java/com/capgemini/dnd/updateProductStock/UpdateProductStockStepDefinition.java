...
public class UpdateProductStockStepDefinition {
	...
	public void user_selects_Passed_Failed_from_Dropdown_menu() {
		Select drpDownQualityStatus = new Select(driver.findElement(By.xpath("/html/body/app-root/body/app-update-product-stock/div[1]/form/div[4]/div/div[2]/select")));
	...
	public void user_clicks_update_stock_button_below() {
		...
		WebElement updateBtn = driver.findElement(By.xpath("/html/body/app-root/body/app-update-product-stock/div[1]/form/button"));
		JavascriptExecutor jsButton = (JavascriptExecutor)driver;
		jsButton.executeScript("arguments[0].click();", updateBtn);
	}
